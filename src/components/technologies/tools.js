...
const Tools = () => {
    return(
        <div className="tools">
            ...
            <img className='tool-5' width="76" height="76" src="https://img.icons8.com/color/76/bootstrap.png" alt="bootstrap"/>
            <img className='tool-6' width="96" height="96" src="https://img.icons8.com/color/96/git.png" alt="git"/>
        </div>
        </div>
